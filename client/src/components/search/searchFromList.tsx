    ...
    return (
        <div>
            <div className="flex rounded-lg overflow-hidden px-2 items-center gap-1 md:border-[1px] border-b-[1px] border-gray-300 mb-2">
                ...
                <div>
                    <input value={searchValue} onChange={(e) => setSearchValue(e.target.value)} className="border-none bg-transparent outline-none p-4 md:p-2" type="text" placeholder="Search" id="search" />
                </div>
            </div>
        </div>
    )
