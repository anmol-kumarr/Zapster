    ...
    return (
        <div className="relative">
            <div className="flex rounded-lg overflow-hidden px-2 items-center gap-1 shadow-[1px_1px_5px_#79C5EF]">
                ...
                <div>
                    <input value={searchValue} onChange={(e) => setSearchValue(e.target.value)} className=" p-3 px-3 text-lg md:px-0  border-none outline-none md:p-2" type="text" placeholder="Search" id="search" />
                </div>
            </div>
